...
const imageHotspots: Record<DisciplinePair, Hotspot[]> = {
  '美术+语文': [
    { id: 'my_1', infoKey: '国画', style: { top: '15%', left: '10%', width: '20%', height: '15%' } },
    { id: 'my_2', infoKey: '诗词', style: { top: '35%', left: '70%', width: '18%', height: '12%' } },
    { id: 'my_3', infoKey: '书法', style: { top: '60%', left: '25%', width: '15%', height: '20%' } },
    // ... 可以添加更多热区
  ],
  '美术+数学': [], // 待添加
  '美术+历史': [], // 待添加
...
const disciplinePairs = ref<DisciplinePair[]>(['美术+语文', '美术+数学', '美术+历史', '美术+地理', '美术+生物']);
...
<template>
  <el-card class="knowledge-graph-card">
    ...
    <div class="image-container">
      <img :src="currentImageSrc" :alt="selectedDisciplinePair + ' 知识图谱'" class="knowledge-image" />
      <!-- 热区容器 -->
