...
import { ArrowLeft, Share, Star, StarFilled, Edit, Delete, InfoFilled } from '@element-plus/icons-vue';
...
const analysisContent = computed(() => {
  // 优先使用analysis字段，如果没有则使用explanation字段
  return props.question.analysis || props.question.explanation || '暂无解析';
});
  ...
  <div class="question-detail">
    ...
    <div v-if="showHeader" class="detail-header">
      ...
      <div class="header-right">
        <el-button-group>
          <el-button type="primary" plain @click="addToPaper">
            加入试卷
          </el-button>
          <el-button 
          ...
          <el-button type="info" plain icon="Share">
            分享
          </el-button>
        </el-button-group>
      </div>
    ...
    <div class="question-content">
      ...
      <div class="question-solution">
        ...
        <div class="solution-content analysis-content">{{ analysisContent }}</div>
      </div>
    </div>
