...
<template>
  <div class="paper-preview">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="课时时长">
            <el-input-number v-model="paperInfo.duration" :min="30" :step="5" placeholder="分钟"></el-input-number>
          </el-form-item>
        </el-col>
      </el-row>
    ...
    <div class="selected-questions">
      ...
      <el-empty v-if="selectedQuestions.length === 0" description="暂无已选美术题目，请从题库中选择或使用智能生成"></el-empty>
      <el-table
        v-else
